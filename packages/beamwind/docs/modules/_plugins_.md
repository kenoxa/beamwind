...
*Defined in [plugins.ts:83](https://github.com/kenoxa/beamwind/blob/main/packages/beamwind/src/plugins.ts#L83)*
...
`rotate` | function | (parts: string[], theme: \<P, K>(section: P, key?: string \| undefined, handleUnknownKey?: [UnknownKeyHandler](_index_.md#unknownkeyhandler)\<NonNullable\<Theme[P]>[K]>) => NonNullable\<NonNullable\<Theme[P]>[K]>) => { transform: string = \`rotate(${theme('angle', parts[1], convertTo('deg'))})\` } |
...
`scale` | function | (parts: string[], theme: \<P, K>(section: P, key?: string \| undefined, handleUnknownKey?: [UnknownKeyHandler](_index_.md#unknownkeyhandler)\<NonNullable\<Theme[P]>[K]>) => NonNullable\<NonNullable\<Theme[P]>[K]>) => { transform: string = \`scale${parts[2] ? parts[1].toUpperCase() : ''}(${theme(       'scale',       parts[2] \|\| parts[1],       divideBy(100),     )})\` } |
...
`skew` | function | (parts: string[], theme: \<P, K>(section: P, key?: string \| undefined, handleUnknownKey?: [UnknownKeyHandler](_index_.md#unknownkeyhandler)\<NonNullable\<Theme[P]>[K]>) => NonNullable\<NonNullable\<Theme[P]>[K]>) => { transform: string = \`skew${parts[1].toUpperCase()}(${theme('angle', parts[2], convertTo('deg'))})\` } |
...
`translate` | function | (parts: string[], theme: \<P, K>(section: P, key?: string \| undefined, handleUnknownKey?: [UnknownKeyHandler](_index_.md#unknownkeyhandler)\<NonNullable\<Theme[P]>[K]>) => NonNullable\<NonNullable\<Theme[P]>[K]>) => { transform: string = \`translate${parts[1].toUpperCase()}(${theme(       'spacing',       parts[2],       convertTo('rem'),     )})\` } |
